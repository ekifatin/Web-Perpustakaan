...
@section('content')
    ...
    <div class="card mb-4 db-lineardb">
                                <div class="card-header">
                                    ...
                                    Peminjaman</h4>
                                    <button class="btn btn-success btn-round ml-auto" data-toggle="modal" data-target="#modalAddPinjam">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#modalHapusPinjam{{ $row->id }}" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
...
<div class="modal fade" id="modalHapusPinjam{{ $g->id }}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
